function realdataname = gen_mtl_fullrank_data_main_zscoreXY(dataname,task_number, sample_size, feature_dim, sample_energe,...
...
[data,label,W,W_rank_use,b] = mtl_syn_MTRL_bias_fullrank(task_number, sample_size, feature_dim,...
                                         sample_energe, noise_level);
