...
% this script construct a W that 
% orthers 
function [data, label,W,W_rank, b] = mtl_syn_MTRL_bias_fullrank_partialcurrupted(task_number, sample_size, feature_dim, sample_energe, noise_level,noise_partial)
% noise_level = 5;
% sample_energe = 10;
% feature_dim = 5;
% task_number = 10;
...
for i = 1:task_number
   ...
   rng(100*i)
   y = randn(num,1)*noise_level*noise_partial(i);
