function model =  MTRL_Omegatrue_interface(data, label,Omega_true,W_true,testX,testY, Options)
...
parfor  i = 1:lenPara
        ...
        model = MTRL_Omegatrue(init, data,label_new,'linear',0,lambda1,lambda2);
